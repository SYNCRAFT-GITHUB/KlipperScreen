...
class KlipperScreenConfig:
        ...
        for section in self.config:
            ...
            if section == 'main':
                bools = (
                    ...
                    'autoclose_popups', 'use_dpms', 'use_default_menu', 'show_saved_from_usb', 'side_brightness_shortcut', 'always_ask_probe',
    ...
    def _create_configurable_options(self, screen):
        ...
        self.configurable_options = [
            ...
            {"always_ask_probe": {"section": "main", "name": _("Returning to the main menu always ask if you want to save the probe after printing"), "type": "binary", "value": "True"}},
