...
class WelcomePanel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        self.buttons = {
            ...
            'STEP_02': self._gtk.Button("bed-level", _("Calibrate"), "color2"),
            'STEP_03': self._gtk.Button("settings", _("Customize"), "color4"),
        ...
        self.buttons['STEP_02'].connect("clicked", self.menu_item_clicked, "STEP_03", {
            "name": _("Calibrate"),
            "panel": "zcalibrate"
        })
        self.buttons['STEP_03'].connect("clicked", self.menu_item_clicked, "STEP_04", {
            "name": _("Customize"),
            "panel": "settings"
        })
